...
//  BullsEye
//
//  Created by Alexander Perse on 12/7/19.
    ...
    var body: some View {
        ...
        Group {
            VStack {
                ...
                Text("This is Bullseye, the game where you can win points and earn fame by dragging a slider.").modifier(AboutBodyStyle())//.lineLimit(nil).multilineTextAlignment(.center)
